...
Транскрипт может быть автоматическим переводом с грузинского языка на английский,
поэтому качество перевода может быть невысоким — оценивай смысл, а не буквальный текст.
